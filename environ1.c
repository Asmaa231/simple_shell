...
/**
 * getenv - It's a Function that could be used in order to fetch an evironment variable
 * @info: The structure will be holding an expected arguments to maintain a Constant Func Prototype
